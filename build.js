...
var _restoreItem = require("./restore-item");
...
_vue2["default"].filter('ttp', function (value) {
    if (!value) {
        return "";
    }
    return value.replace(/https?:\/\//i, "").replace(/_/g, "\\_");
});
var app = new _vue2["default"]({
    ...
    methods: {
        storeItem: function storeItem(e) {
            (0, _restoreItem.storeItem)(JSON.stringify(this.item));
        }
    },
    filters: {
...
var itemValue = (0, _restoreItem.restoreItem)();
if (itemValue) {
    try {
...
},{"./restore-item":4,"vue":2}],4:[function(require,module,exports){
// LICENSE : MIT
"use strict";
